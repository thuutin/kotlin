...
fun testR0xE4() {
    // with possible local optimizations
    if (-1.0 in 1 .. 3 != range0.contains(-1.0)) throw AssertionError()
    if (-1.0 !in 1 .. 3 != !range0.contains(-1.0)) throw AssertionError()
    if (!(-1.0 in 1 .. 3) != !range0.contains(-1.0)) throw AssertionError()
    if (!(-1.0 !in 1 .. 3) != range0.contains(-1.0)) throw AssertionError()
    // no local optimizations
...
fun testR0xE5() {
    // with possible local optimizations
    if (-1.0F in 1 .. 3 != range0.contains(-1.0F)) throw AssertionError()
    if (-1.0F !in 1 .. 3 != !range0.contains(-1.0F)) throw AssertionError()
    if (!(-1.0F in 1 .. 3) != !range0.contains(-1.0F)) throw AssertionError()
    if (!(-1.0F !in 1 .. 3) != range0.contains(-1.0F)) throw AssertionError()
    // no local optimizations
...
fun testR0xE10() {
    // with possible local optimizations
    if (0.0 in 1 .. 3 != range0.contains(0.0)) throw AssertionError()
    if (0.0 !in 1 .. 3 != !range0.contains(0.0)) throw AssertionError()
    if (!(0.0 in 1 .. 3) != !range0.contains(0.0)) throw AssertionError()
    if (!(0.0 !in 1 .. 3) != range0.contains(0.0)) throw AssertionError()
    // no local optimizations
...
fun testR0xE11() {
    // with possible local optimizations
    if (0.0F in 1 .. 3 != range0.contains(0.0F)) throw AssertionError()
    if (0.0F !in 1 .. 3 != !range0.contains(0.0F)) throw AssertionError()
    if (!(0.0F in 1 .. 3) != !range0.contains(0.0F)) throw AssertionError()
    if (!(0.0F !in 1 .. 3) != range0.contains(0.0F)) throw AssertionError()
    // no local optimizations
...
fun testR0xE22() {
    // with possible local optimizations
    if (2.0 in 1 .. 3 != range0.contains(2.0)) throw AssertionError()
    if (2.0 !in 1 .. 3 != !range0.contains(2.0)) throw AssertionError()
    if (!(2.0 in 1 .. 3) != !range0.contains(2.0)) throw AssertionError()
    if (!(2.0 !in 1 .. 3) != range0.contains(2.0)) throw AssertionError()
    // no local optimizations
...
fun testR0xE23() {
    // with possible local optimizations
    if (2.0F in 1 .. 3 != range0.contains(2.0F)) throw AssertionError()
    if (2.0F !in 1 .. 3 != !range0.contains(2.0F)) throw AssertionError()
    if (!(2.0F in 1 .. 3) != !range0.contains(2.0F)) throw AssertionError()
    if (!(2.0F !in 1 .. 3) != range0.contains(2.0F)) throw AssertionError()
    // no local optimizations
...
fun testR0xE28() {
    // with possible local optimizations
    if (3.0 in 1 .. 3 != range0.contains(3.0)) throw AssertionError()
    if (3.0 !in 1 .. 3 != !range0.contains(3.0)) throw AssertionError()
    if (!(3.0 in 1 .. 3) != !range0.contains(3.0)) throw AssertionError()
    if (!(3.0 !in 1 .. 3) != range0.contains(3.0)) throw AssertionError()
    // no local optimizations
...
fun testR0xE29() {
    // with possible local optimizations
    if (3.0F in 1 .. 3 != range0.contains(3.0F)) throw AssertionError()
    if (3.0F !in 1 .. 3 != !range0.contains(3.0F)) throw AssertionError()
    if (!(3.0F in 1 .. 3) != !range0.contains(3.0F)) throw AssertionError()
    if (!(3.0F !in 1 .. 3) != range0.contains(3.0F)) throw AssertionError()
    // no local optimizations
...
fun testR0xE34() {
    // with possible local optimizations
    if (4.0 in 1 .. 3 != range0.contains(4.0)) throw AssertionError()
    if (4.0 !in 1 .. 3 != !range0.contains(4.0)) throw AssertionError()
    if (!(4.0 in 1 .. 3) != !range0.contains(4.0)) throw AssertionError()
    if (!(4.0 !in 1 .. 3) != range0.contains(4.0)) throw AssertionError()
    // no local optimizations
...
fun testR0xE35() {
    // with possible local optimizations
    if (4.0F in 1 .. 3 != range0.contains(4.0F)) throw AssertionError()
    if (4.0F !in 1 .. 3 != !range0.contains(4.0F)) throw AssertionError()
    if (!(4.0F in 1 .. 3) != !range0.contains(4.0F)) throw AssertionError()
    if (!(4.0F !in 1 .. 3) != range0.contains(4.0F)) throw AssertionError()
    // no local optimizations
...
fun testR1xE4() {
    // with possible local optimizations
    if (-1.0 in 3 .. 1 != range1.contains(-1.0)) throw AssertionError()
    if (-1.0 !in 3 .. 1 != !range1.contains(-1.0)) throw AssertionError()
    if (!(-1.0 in 3 .. 1) != !range1.contains(-1.0)) throw AssertionError()
    if (!(-1.0 !in 3 .. 1) != range1.contains(-1.0)) throw AssertionError()
    // no local optimizations
...
fun testR1xE5() {
    // with possible local optimizations
    if (-1.0F in 3 .. 1 != range1.contains(-1.0F)) throw AssertionError()
    if (-1.0F !in 3 .. 1 != !range1.contains(-1.0F)) throw AssertionError()
    if (!(-1.0F in 3 .. 1) != !range1.contains(-1.0F)) throw AssertionError()
    if (!(-1.0F !in 3 .. 1) != range1.contains(-1.0F)) throw AssertionError()
    // no local optimizations
...
fun testR1xE10() {
    // with possible local optimizations
    if (0.0 in 3 .. 1 != range1.contains(0.0)) throw AssertionError()
    if (0.0 !in 3 .. 1 != !range1.contains(0.0)) throw AssertionError()
    if (!(0.0 in 3 .. 1) != !range1.contains(0.0)) throw AssertionError()
    if (!(0.0 !in 3 .. 1) != range1.contains(0.0)) throw AssertionError()
    // no local optimizations
...
fun testR1xE11() {
    // with possible local optimizations
    if (0.0F in 3 .. 1 != range1.contains(0.0F)) throw AssertionError()
    if (0.0F !in 3 .. 1 != !range1.contains(0.0F)) throw AssertionError()
    if (!(0.0F in 3 .. 1) != !range1.contains(0.0F)) throw AssertionError()
    if (!(0.0F !in 3 .. 1) != range1.contains(0.0F)) throw AssertionError()
    // no local optimizations
...
fun testR1xE22() {
    // with possible local optimizations
    if (2.0 in 3 .. 1 != range1.contains(2.0)) throw AssertionError()
    if (2.0 !in 3 .. 1 != !range1.contains(2.0)) throw AssertionError()
    if (!(2.0 in 3 .. 1) != !range1.contains(2.0)) throw AssertionError()
    if (!(2.0 !in 3 .. 1) != range1.contains(2.0)) throw AssertionError()
    // no local optimizations
...
fun testR1xE23() {
    // with possible local optimizations
    if (2.0F in 3 .. 1 != range1.contains(2.0F)) throw AssertionError()
    if (2.0F !in 3 .. 1 != !range1.contains(2.0F)) throw AssertionError()
    if (!(2.0F in 3 .. 1) != !range1.contains(2.0F)) throw AssertionError()
    if (!(2.0F !in 3 .. 1) != range1.contains(2.0F)) throw AssertionError()
    // no local optimizations
...
fun testR1xE28() {
    // with possible local optimizations
    if (3.0 in 3 .. 1 != range1.contains(3.0)) throw AssertionError()
    if (3.0 !in 3 .. 1 != !range1.contains(3.0)) throw AssertionError()
    if (!(3.0 in 3 .. 1) != !range1.contains(3.0)) throw AssertionError()
    if (!(3.0 !in 3 .. 1) != range1.contains(3.0)) throw AssertionError()
    // no local optimizations
...
fun testR1xE29() {
    // with possible local optimizations
    if (3.0F in 3 .. 1 != range1.contains(3.0F)) throw AssertionError()
    if (3.0F !in 3 .. 1 != !range1.contains(3.0F)) throw AssertionError()
    if (!(3.0F in 3 .. 1) != !range1.contains(3.0F)) throw AssertionError()
    if (!(3.0F !in 3 .. 1) != range1.contains(3.0F)) throw AssertionError()
    // no local optimizations
...
fun testR1xE34() {
    // with possible local optimizations
    if (4.0 in 3 .. 1 != range1.contains(4.0)) throw AssertionError()
    if (4.0 !in 3 .. 1 != !range1.contains(4.0)) throw AssertionError()
    if (!(4.0 in 3 .. 1) != !range1.contains(4.0)) throw AssertionError()
    if (!(4.0 !in 3 .. 1) != range1.contains(4.0)) throw AssertionError()
    // no local optimizations
...
fun testR1xE35() {
    // with possible local optimizations
    if (4.0F in 3 .. 1 != range1.contains(4.0F)) throw AssertionError()
    if (4.0F !in 3 .. 1 != !range1.contains(4.0F)) throw AssertionError()
    if (!(4.0F in 3 .. 1) != !range1.contains(4.0F)) throw AssertionError()
    if (!(4.0F !in 3 .. 1) != range1.contains(4.0F)) throw AssertionError()
    // no local optimizations
