...
fun testR0xE4() {
    // with possible local optimizations
    if (-1.0 in intArray.indices != range0.contains(-1.0)) throw AssertionError()
    if (-1.0 !in intArray.indices != !range0.contains(-1.0)) throw AssertionError()
    if (!(-1.0 in intArray.indices) != !range0.contains(-1.0)) throw AssertionError()
    if (!(-1.0 !in intArray.indices) != range0.contains(-1.0)) throw AssertionError()
    // no local optimizations
...
fun testR0xE5() {
    // with possible local optimizations
    if (-1.0F in intArray.indices != range0.contains(-1.0F)) throw AssertionError()
    if (-1.0F !in intArray.indices != !range0.contains(-1.0F)) throw AssertionError()
    if (!(-1.0F in intArray.indices) != !range0.contains(-1.0F)) throw AssertionError()
    if (!(-1.0F !in intArray.indices) != range0.contains(-1.0F)) throw AssertionError()
    // no local optimizations
...
fun testR0xE10() {
    // with possible local optimizations
    if (0.0 in intArray.indices != range0.contains(0.0)) throw AssertionError()
    if (0.0 !in intArray.indices != !range0.contains(0.0)) throw AssertionError()
    if (!(0.0 in intArray.indices) != !range0.contains(0.0)) throw AssertionError()
    if (!(0.0 !in intArray.indices) != range0.contains(0.0)) throw AssertionError()
    // no local optimizations
...
fun testR0xE11() {
    // with possible local optimizations
    if (0.0F in intArray.indices != range0.contains(0.0F)) throw AssertionError()
    if (0.0F !in intArray.indices != !range0.contains(0.0F)) throw AssertionError()
    if (!(0.0F in intArray.indices) != !range0.contains(0.0F)) throw AssertionError()
    if (!(0.0F !in intArray.indices) != range0.contains(0.0F)) throw AssertionError()
    // no local optimizations
...
fun testR0xE22() {
    // with possible local optimizations
    if (2.0 in intArray.indices != range0.contains(2.0)) throw AssertionError()
    if (2.0 !in intArray.indices != !range0.contains(2.0)) throw AssertionError()
    if (!(2.0 in intArray.indices) != !range0.contains(2.0)) throw AssertionError()
    if (!(2.0 !in intArray.indices) != range0.contains(2.0)) throw AssertionError()
    // no local optimizations
...
fun testR0xE23() {
    // with possible local optimizations
    if (2.0F in intArray.indices != range0.contains(2.0F)) throw AssertionError()
    if (2.0F !in intArray.indices != !range0.contains(2.0F)) throw AssertionError()
    if (!(2.0F in intArray.indices) != !range0.contains(2.0F)) throw AssertionError()
    if (!(2.0F !in intArray.indices) != range0.contains(2.0F)) throw AssertionError()
    // no local optimizations
...
fun testR0xE28() {
    // with possible local optimizations
    if (3.0 in intArray.indices != range0.contains(3.0)) throw AssertionError()
    if (3.0 !in intArray.indices != !range0.contains(3.0)) throw AssertionError()
    if (!(3.0 in intArray.indices) != !range0.contains(3.0)) throw AssertionError()
    if (!(3.0 !in intArray.indices) != range0.contains(3.0)) throw AssertionError()
    // no local optimizations
...
fun testR0xE29() {
    // with possible local optimizations
    if (3.0F in intArray.indices != range0.contains(3.0F)) throw AssertionError()
    if (3.0F !in intArray.indices != !range0.contains(3.0F)) throw AssertionError()
    if (!(3.0F in intArray.indices) != !range0.contains(3.0F)) throw AssertionError()
    if (!(3.0F !in intArray.indices) != range0.contains(3.0F)) throw AssertionError()
    // no local optimizations
...
fun testR0xE34() {
    // with possible local optimizations
    if (4.0 in intArray.indices != range0.contains(4.0)) throw AssertionError()
    if (4.0 !in intArray.indices != !range0.contains(4.0)) throw AssertionError()
    if (!(4.0 in intArray.indices) != !range0.contains(4.0)) throw AssertionError()
    if (!(4.0 !in intArray.indices) != range0.contains(4.0)) throw AssertionError()
    // no local optimizations
...
fun testR0xE35() {
    // with possible local optimizations
    if (4.0F in intArray.indices != range0.contains(4.0F)) throw AssertionError()
    if (4.0F !in intArray.indices != !range0.contains(4.0F)) throw AssertionError()
    if (!(4.0F in intArray.indices) != !range0.contains(4.0F)) throw AssertionError()
    if (!(4.0F !in intArray.indices) != range0.contains(4.0F)) throw AssertionError()
    // no local optimizations
...
fun testR1xE4() {
    // with possible local optimizations
    if (-1.0 in objectArray.indices != range1.contains(-1.0)) throw AssertionError()
    if (-1.0 !in objectArray.indices != !range1.contains(-1.0)) throw AssertionError()
    if (!(-1.0 in objectArray.indices) != !range1.contains(-1.0)) throw AssertionError()
    if (!(-1.0 !in objectArray.indices) != range1.contains(-1.0)) throw AssertionError()
    // no local optimizations
...
fun testR1xE5() {
    // with possible local optimizations
    if (-1.0F in objectArray.indices != range1.contains(-1.0F)) throw AssertionError()
    if (-1.0F !in objectArray.indices != !range1.contains(-1.0F)) throw AssertionError()
    if (!(-1.0F in objectArray.indices) != !range1.contains(-1.0F)) throw AssertionError()
    if (!(-1.0F !in objectArray.indices) != range1.contains(-1.0F)) throw AssertionError()
    // no local optimizations
...
fun testR1xE10() {
    // with possible local optimizations
    if (0.0 in objectArray.indices != range1.contains(0.0)) throw AssertionError()
    if (0.0 !in objectArray.indices != !range1.contains(0.0)) throw AssertionError()
    if (!(0.0 in objectArray.indices) != !range1.contains(0.0)) throw AssertionError()
    if (!(0.0 !in objectArray.indices) != range1.contains(0.0)) throw AssertionError()
    // no local optimizations
...
fun testR1xE11() {
    // with possible local optimizations
    if (0.0F in objectArray.indices != range1.contains(0.0F)) throw AssertionError()
    if (0.0F !in objectArray.indices != !range1.contains(0.0F)) throw AssertionError()
    if (!(0.0F in objectArray.indices) != !range1.contains(0.0F)) throw AssertionError()
    if (!(0.0F !in objectArray.indices) != range1.contains(0.0F)) throw AssertionError()
    // no local optimizations
...
fun testR1xE22() {
    // with possible local optimizations
    if (2.0 in objectArray.indices != range1.contains(2.0)) throw AssertionError()
    if (2.0 !in objectArray.indices != !range1.contains(2.0)) throw AssertionError()
    if (!(2.0 in objectArray.indices) != !range1.contains(2.0)) throw AssertionError()
    if (!(2.0 !in objectArray.indices) != range1.contains(2.0)) throw AssertionError()
    // no local optimizations
...
fun testR1xE23() {
    // with possible local optimizations
    if (2.0F in objectArray.indices != range1.contains(2.0F)) throw AssertionError()
    if (2.0F !in objectArray.indices != !range1.contains(2.0F)) throw AssertionError()
    if (!(2.0F in objectArray.indices) != !range1.contains(2.0F)) throw AssertionError()
    if (!(2.0F !in objectArray.indices) != range1.contains(2.0F)) throw AssertionError()
    // no local optimizations
...
fun testR1xE28() {
    // with possible local optimizations
    if (3.0 in objectArray.indices != range1.contains(3.0)) throw AssertionError()
    if (3.0 !in objectArray.indices != !range1.contains(3.0)) throw AssertionError()
    if (!(3.0 in objectArray.indices) != !range1.contains(3.0)) throw AssertionError()
    if (!(3.0 !in objectArray.indices) != range1.contains(3.0)) throw AssertionError()
    // no local optimizations
...
fun testR1xE29() {
    // with possible local optimizations
    if (3.0F in objectArray.indices != range1.contains(3.0F)) throw AssertionError()
    if (3.0F !in objectArray.indices != !range1.contains(3.0F)) throw AssertionError()
    if (!(3.0F in objectArray.indices) != !range1.contains(3.0F)) throw AssertionError()
    if (!(3.0F !in objectArray.indices) != range1.contains(3.0F)) throw AssertionError()
    // no local optimizations
...
fun testR1xE34() {
    // with possible local optimizations
    if (4.0 in objectArray.indices != range1.contains(4.0)) throw AssertionError()
    if (4.0 !in objectArray.indices != !range1.contains(4.0)) throw AssertionError()
    if (!(4.0 in objectArray.indices) != !range1.contains(4.0)) throw AssertionError()
    if (!(4.0 !in objectArray.indices) != range1.contains(4.0)) throw AssertionError()
    // no local optimizations
...
fun testR1xE35() {
    // with possible local optimizations
    if (4.0F in objectArray.indices != range1.contains(4.0F)) throw AssertionError()
    if (4.0F !in objectArray.indices != !range1.contains(4.0F)) throw AssertionError()
    if (!(4.0F in objectArray.indices) != !range1.contains(4.0F)) throw AssertionError()
    if (!(4.0F !in objectArray.indices) != range1.contains(4.0F)) throw AssertionError()
    // no local optimizations
...
fun testR2xE4() {
    // with possible local optimizations
    if (-1.0 in emptyIntArray.indices != range2.contains(-1.0)) throw AssertionError()
    if (-1.0 !in emptyIntArray.indices != !range2.contains(-1.0)) throw AssertionError()
    if (!(-1.0 in emptyIntArray.indices) != !range2.contains(-1.0)) throw AssertionError()
    if (!(-1.0 !in emptyIntArray.indices) != range2.contains(-1.0)) throw AssertionError()
    // no local optimizations
...
fun testR2xE5() {
    // with possible local optimizations
    if (-1.0F in emptyIntArray.indices != range2.contains(-1.0F)) throw AssertionError()
    if (-1.0F !in emptyIntArray.indices != !range2.contains(-1.0F)) throw AssertionError()
    if (!(-1.0F in emptyIntArray.indices) != !range2.contains(-1.0F)) throw AssertionError()
    if (!(-1.0F !in emptyIntArray.indices) != range2.contains(-1.0F)) throw AssertionError()
    // no local optimizations
...
fun testR2xE10() {
    // with possible local optimizations
    if (0.0 in emptyIntArray.indices != range2.contains(0.0)) throw AssertionError()
    if (0.0 !in emptyIntArray.indices != !range2.contains(0.0)) throw AssertionError()
    if (!(0.0 in emptyIntArray.indices) != !range2.contains(0.0)) throw AssertionError()
    if (!(0.0 !in emptyIntArray.indices) != range2.contains(0.0)) throw AssertionError()
    // no local optimizations
...
fun testR2xE11() {
    // with possible local optimizations
    if (0.0F in emptyIntArray.indices != range2.contains(0.0F)) throw AssertionError()
    if (0.0F !in emptyIntArray.indices != !range2.contains(0.0F)) throw AssertionError()
    if (!(0.0F in emptyIntArray.indices) != !range2.contains(0.0F)) throw AssertionError()
    if (!(0.0F !in emptyIntArray.indices) != range2.contains(0.0F)) throw AssertionError()
    // no local optimizations
...
fun testR2xE22() {
    // with possible local optimizations
    if (2.0 in emptyIntArray.indices != range2.contains(2.0)) throw AssertionError()
    if (2.0 !in emptyIntArray.indices != !range2.contains(2.0)) throw AssertionError()
    if (!(2.0 in emptyIntArray.indices) != !range2.contains(2.0)) throw AssertionError()
    if (!(2.0 !in emptyIntArray.indices) != range2.contains(2.0)) throw AssertionError()
    // no local optimizations
...
fun testR2xE23() {
    // with possible local optimizations
    if (2.0F in emptyIntArray.indices != range2.contains(2.0F)) throw AssertionError()
    if (2.0F !in emptyIntArray.indices != !range2.contains(2.0F)) throw AssertionError()
    if (!(2.0F in emptyIntArray.indices) != !range2.contains(2.0F)) throw AssertionError()
    if (!(2.0F !in emptyIntArray.indices) != range2.contains(2.0F)) throw AssertionError()
    // no local optimizations
...
fun testR2xE28() {
    // with possible local optimizations
    if (3.0 in emptyIntArray.indices != range2.contains(3.0)) throw AssertionError()
    if (3.0 !in emptyIntArray.indices != !range2.contains(3.0)) throw AssertionError()
    if (!(3.0 in emptyIntArray.indices) != !range2.contains(3.0)) throw AssertionError()
    if (!(3.0 !in emptyIntArray.indices) != range2.contains(3.0)) throw AssertionError()
    // no local optimizations
...
fun testR2xE29() {
    // with possible local optimizations
    if (3.0F in emptyIntArray.indices != range2.contains(3.0F)) throw AssertionError()
    if (3.0F !in emptyIntArray.indices != !range2.contains(3.0F)) throw AssertionError()
    if (!(3.0F in emptyIntArray.indices) != !range2.contains(3.0F)) throw AssertionError()
    if (!(3.0F !in emptyIntArray.indices) != range2.contains(3.0F)) throw AssertionError()
    // no local optimizations
...
fun testR2xE34() {
    // with possible local optimizations
    if (4.0 in emptyIntArray.indices != range2.contains(4.0)) throw AssertionError()
    if (4.0 !in emptyIntArray.indices != !range2.contains(4.0)) throw AssertionError()
    if (!(4.0 in emptyIntArray.indices) != !range2.contains(4.0)) throw AssertionError()
    if (!(4.0 !in emptyIntArray.indices) != range2.contains(4.0)) throw AssertionError()
    // no local optimizations
...
fun testR2xE35() {
    // with possible local optimizations
    if (4.0F in emptyIntArray.indices != range2.contains(4.0F)) throw AssertionError()
    if (4.0F !in emptyIntArray.indices != !range2.contains(4.0F)) throw AssertionError()
    if (!(4.0F in emptyIntArray.indices) != !range2.contains(4.0F)) throw AssertionError()
    if (!(4.0F !in emptyIntArray.indices) != range2.contains(4.0F)) throw AssertionError()
    // no local optimizations
...
fun testR3xE4() {
    // with possible local optimizations
    if (-1.0 in emptyObjectArray.indices != range3.contains(-1.0)) throw AssertionError()
    if (-1.0 !in emptyObjectArray.indices != !range3.contains(-1.0)) throw AssertionError()
    if (!(-1.0 in emptyObjectArray.indices) != !range3.contains(-1.0)) throw AssertionError()
    if (!(-1.0 !in emptyObjectArray.indices) != range3.contains(-1.0)) throw AssertionError()
    // no local optimizations
...
fun testR3xE5() {
    // with possible local optimizations
    if (-1.0F in emptyObjectArray.indices != range3.contains(-1.0F)) throw AssertionError()
    if (-1.0F !in emptyObjectArray.indices != !range3.contains(-1.0F)) throw AssertionError()
    if (!(-1.0F in emptyObjectArray.indices) != !range3.contains(-1.0F)) throw AssertionError()
    if (!(-1.0F !in emptyObjectArray.indices) != range3.contains(-1.0F)) throw AssertionError()
    // no local optimizations
...
fun testR3xE10() {
    // with possible local optimizations
    if (0.0 in emptyObjectArray.indices != range3.contains(0.0)) throw AssertionError()
    if (0.0 !in emptyObjectArray.indices != !range3.contains(0.0)) throw AssertionError()
    if (!(0.0 in emptyObjectArray.indices) != !range3.contains(0.0)) throw AssertionError()
    if (!(0.0 !in emptyObjectArray.indices) != range3.contains(0.0)) throw AssertionError()
    // no local optimizations
...
fun testR3xE11() {
    // with possible local optimizations
    if (0.0F in emptyObjectArray.indices != range3.contains(0.0F)) throw AssertionError()
    if (0.0F !in emptyObjectArray.indices != !range3.contains(0.0F)) throw AssertionError()
    if (!(0.0F in emptyObjectArray.indices) != !range3.contains(0.0F)) throw AssertionError()
    if (!(0.0F !in emptyObjectArray.indices) != range3.contains(0.0F)) throw AssertionError()
    // no local optimizations
...
fun testR3xE22() {
    // with possible local optimizations
    if (2.0 in emptyObjectArray.indices != range3.contains(2.0)) throw AssertionError()
    if (2.0 !in emptyObjectArray.indices != !range3.contains(2.0)) throw AssertionError()
    if (!(2.0 in emptyObjectArray.indices) != !range3.contains(2.0)) throw AssertionError()
    if (!(2.0 !in emptyObjectArray.indices) != range3.contains(2.0)) throw AssertionError()
    // no local optimizations
...
fun testR3xE23() {
    // with possible local optimizations
    if (2.0F in emptyObjectArray.indices != range3.contains(2.0F)) throw AssertionError()
    if (2.0F !in emptyObjectArray.indices != !range3.contains(2.0F)) throw AssertionError()
    if (!(2.0F in emptyObjectArray.indices) != !range3.contains(2.0F)) throw AssertionError()
    if (!(2.0F !in emptyObjectArray.indices) != range3.contains(2.0F)) throw AssertionError()
    // no local optimizations
...
fun testR3xE28() {
    // with possible local optimizations
    if (3.0 in emptyObjectArray.indices != range3.contains(3.0)) throw AssertionError()
    if (3.0 !in emptyObjectArray.indices != !range3.contains(3.0)) throw AssertionError()
    if (!(3.0 in emptyObjectArray.indices) != !range3.contains(3.0)) throw AssertionError()
    if (!(3.0 !in emptyObjectArray.indices) != range3.contains(3.0)) throw AssertionError()
    // no local optimizations
...
fun testR3xE29() {
    // with possible local optimizations
    if (3.0F in emptyObjectArray.indices != range3.contains(3.0F)) throw AssertionError()
    if (3.0F !in emptyObjectArray.indices != !range3.contains(3.0F)) throw AssertionError()
    if (!(3.0F in emptyObjectArray.indices) != !range3.contains(3.0F)) throw AssertionError()
    if (!(3.0F !in emptyObjectArray.indices) != range3.contains(3.0F)) throw AssertionError()
    // no local optimizations
...
fun testR3xE34() {
    // with possible local optimizations
    if (4.0 in emptyObjectArray.indices != range3.contains(4.0)) throw AssertionError()
    if (4.0 !in emptyObjectArray.indices != !range3.contains(4.0)) throw AssertionError()
    if (!(4.0 in emptyObjectArray.indices) != !range3.contains(4.0)) throw AssertionError()
    if (!(4.0 !in emptyObjectArray.indices) != range3.contains(4.0)) throw AssertionError()
    // no local optimizations
...
fun testR3xE35() {
    // with possible local optimizations
    if (4.0F in emptyObjectArray.indices != range3.contains(4.0F)) throw AssertionError()
    if (4.0F !in emptyObjectArray.indices != !range3.contains(4.0F)) throw AssertionError()
    if (!(4.0F in emptyObjectArray.indices) != !range3.contains(4.0F)) throw AssertionError()
    if (!(4.0F !in emptyObjectArray.indices) != range3.contains(4.0F)) throw AssertionError()
    // no local optimizations
