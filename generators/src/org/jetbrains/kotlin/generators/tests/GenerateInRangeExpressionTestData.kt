...
object GenerateInRangeExpressionTestData {
    ...
    private val PREAMBLE_MESSAGE = "Auto-generated by ${this@GenerateInRangeExpressionTestData::class.java.simpleName}. Do not edit!"
    ...
    fun main(args: Array<String>) {
        ...
        val numericLiterals =
                listOf("-1", "0", "1", "2", "3", "4").flatMap {
                    listOf("$it.toByte()", "$it.toShort()", it, "${it}L", "$it.0", "$it.0F")
                }
